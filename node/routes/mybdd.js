...
var infos =[
  { route: '/bdd/sports/create', message: 'Create table and add datas'},
...
router.get( '/sports/create' , function(req, res , next) {
        ...
        dbtool.connect(server.pool).then(con => {
          ...
          .then(result =>  { 
           ...
           conn.release();
           return res.json({ status:200 , message :'inserted datas in table sports ' + nb  });
         }).catch(error => {
           if (conn) {
             conn.release();
           }
...
router.get( '/sports/drop' , function(req, res , next) {
  //id, name, surname , discipline , date , duree
  var conn = undefined ;
  ...
  dbtool.connect(server.pool).then(con => {
     ...
     conn.release();
     return res.json({ status:200 , message: 'drop table sports'  });
   }).catch(error => {
     if (conn) {
       conn.release();
     }
...
///////////////////////////////////////////////////////////////////
router.get( '/sports/delete' , function(req, res , next) {
  //id, name, surname , discipline , date , duree
  var conn = undefined ;
  ...
  dbtool.connect(server.pool).then(con => {
     ...
     conn.release();
     return res.json({ status:200 , message :'delete table sports' });
   }).catch(error => {
     if (conn) {
       conn.release();
     }
...
router.get( '/books/delete' , function(req, res , next) {
  ...
  dbtool.connect(server.pool).then(con => {
     ...
     conn.release();
     return res.json({ status:200 , message :'delete table books'  });
   }).catch(error => {
     if (conn) {
       conn.release();
     }
...
router.get( '/books/drop' , function(req, res , next) {
  ...
  dbtool.connect(server.pool).then(con => {
     ...
     conn.release();
     return res.json({ status:200 , message :'drop table books'  });
   }).catch(error => {
     if (conn) {
       conn.release();
     }
...
router.get( '/books/create' , function(req, res , next) {
  ...
  dbtool.connect(server.pool).then(con => {
    ...
    .then(result =>  { 
     var nb = result[0].total ;
     conn.release();
     return res.json({ status:200 , message :'inserted datas in table books ' +nb   });
   }).catch(error => {
     if (conn) {
       conn.release();
     }
